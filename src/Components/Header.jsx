  ...
  return (
    <header>
      <nav className="py-4 sm:py-8 flex flex-row justify-between items-center mx-[0.5rem] sm:mx-0">
        <h1 className="sm:hidden">Rupdip</h1>
